...
var Slot3 = React13.forwardRef((props, forwardedRef) => {
  ...
  if (slottable) {
    ...
    return (0, import_jsx_runtime7.jsx)(SlotClone3, { ...slotProps, ref: forwardedRef, children: React13.isValidElement(newElement) ? React13.cloneElement(newElement, void 0, newChildren) : null });
  }
...
var useLayoutEffect2 = Boolean(globalThis == null ? void 0 : globalThis.document) ? React15.useLayoutEffect : () => {
};
...
var Portal = React16.forwardRef((props, forwardedRef) => {
  ...
  return container ? import_react_dom.default.createPortal((0, import_jsx_runtime9.jsx)(Primitive2.div, { ...portalProps, ref: forwardedRef }), container) : null;
});
...
function useComposedRefs4(...refs) {
  return React17.useCallback(composeRefs5(...refs), refs);
}
...
var Slot4 = React19.forwardRef((props, forwardedRef) => {
  ...
  if (slottable) {
    ...
    return (0, import_jsx_runtime10.jsx)(SlotClone4, { ...slotProps, ref: forwardedRef, children: React19.isValidElement(newElement) ? React19.cloneElement(newElement, void 0, newChildren) : null });
  }
...
var Slot5 = React24.forwardRef((props, forwardedRef) => {
  const { children, ...slotProps } = props;
  ...
  if (slottable) {
    ...
    return (0, import_jsx_runtime12.jsx)(SlotClone5, { ...slotProps, ref: forwardedRef, children: React24.isValidElement(newElement) ? React24.cloneElement(newElement, void 0, newChildren) : null });
  }
  return (0, import_jsx_runtime12.jsx)(SlotClone5, { ...slotProps, ref: forwardedRef, children });
});
Slot5.displayName = "Slot";
var SlotClone5 = React24.forwardRef((props, forwardedRef) => {
  const { children, ...slotProps } = props;
  if (React24.isValidElement(children)) {
    ...
    return React24.cloneElement(children, {
      ...
      // @ts-ignore
      ref: forwardedRef ? composeRefs6(forwardedRef, childrenRef) : childrenRef
    });
  }
...
function isSlottable5(child) {
  return React24.isValidElement(child) && child.type === Slottable5;
}
...
var ToastProvider = (props) => {
  ...
  return (0, import_jsx_runtime15.jsx)(Collection.Provider, { scope: __scopeToast, children: (0, import_jsx_runtime15.jsx)(
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime15.jsxs)(
      Branch,
      {
        ...
        children: [
          hasToasts && (0, import_jsx_runtime15.jsx)(
            FocusProxy,
            {
          ...
          (0, import_jsx_runtime15.jsx)(Collection.Slot, { scope: __scopeToast, children: (0, import_jsx_runtime15.jsx)(Primitive3.ol, { tabIndex: -1, ...viewportProps, ref: composedRefs }) }),
          hasToasts && (0, import_jsx_runtime15.jsx)(
            FocusProxy,
            {
...
var Toast = React27.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime15.jsx)(Presence, { present: forceMount || open, children: (0, import_jsx_runtime15.jsx)(
      ToastImpl,
      {
        open,
        ...toastProps,
...
var ToastImpl = React27.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime15.jsxs)(import_jsx_runtime15.Fragment, { children: [
      announceTextContent && (0, import_jsx_runtime15.jsx)(
        ToastAnnounce,
        {
          __scopeToast,
          role: "status",
      ...
      (0, import_jsx_runtime15.jsx)(ToastInteractiveProvider, { scope: __scopeToast, onClose: handleClose, children: ReactDOM6.createPortal(
        (0, import_jsx_runtime15.jsx)(Collection.ItemSlot, { scope: __scopeToast, children: (0, import_jsx_runtime15.jsx)(
          Root,
          {
            asChild: true,
...
var ToastAnnounce = (props) => {
  ...
  return isAnnounced ? null : (0, import_jsx_runtime15.jsx)(Portal, { asChild: true, children: (0, import_jsx_runtime15.jsx)(VisuallyHidden, { ...announceProps, children: renderAnnounceText && (0, import_jsx_runtime15.jsxs)(import_jsx_runtime15.Fragment, { children: [
    context.label,
    " ",
    children
  ] }) }) });
...
var ToastTitle = React27.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime15.jsx)(Primitive3.div, { ...titleProps, ref: forwardedRef });
  }
);
...
var ToastDescription = React27.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime15.jsx)(Primitive3.div, { ...descriptionProps, ref: forwardedRef });
  }
);
...
var ToastAction = React27.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime15.jsx)(ToastAnnounceExclude, { altText, asChild: true, children: (0, import_jsx_runtime15.jsx)(ToastClose, { ...actionProps, ref: forwardedRef }) });
  }
);
...
var ToastClose = React27.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime15.jsx)(ToastAnnounceExclude, { asChild: true, children: (0, import_jsx_runtime15.jsx)(
      Primitive3.button,
      {
        type: "button",
        ...closeProps,
